...
public class Chunk : MonoBehaviour
{
    ...
    {
        newTriangles.Add(faceCount * 4); // Point 1
        newTriangles.Add(faceCount * 4 + 1); // Point 2
        newTriangles.Add(faceCount * 4 + 2); // Point 3
        newTriangles.Add(faceCount * 4); // Point 1
        newTriangles.Add(faceCount * 4 + 2); // Point 3
        newTriangles.Add(faceCount * 4 + 3); // Point 4
